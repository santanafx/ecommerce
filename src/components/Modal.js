                ...
                <div className='modalContainer'>
                    <div className='modalImgs'>
                        ...
                        <div className='modalImgsTn'>
                            <img onClick={(event) => { handleChangeImg(event.target.getAttribute("picture")) }} src={tn1} alt="" picture={img1} tabIndex="5" />
                            <img onClick={(event) => { handleChangeImg(event.target.getAttribute("picture")) }} src={tn2} alt="" picture={img2} tabIndex="6" />
                            <img onClick={(event) => { handleChangeImg(event.target.getAttribute("picture")) }} src={tn3} alt="" picture={img3} tabIndex="7" />
                            <img onClick={(event) => { handleChangeImg(event.target.getAttribute("picture")) }} src={tn4} alt="" picture={img4} tabIndex="8" />
                        </div>
